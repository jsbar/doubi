...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/jsbar/v2ray-core/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/jsbar/v2ray-core/releases/latest"
