...
curl -L  -k https://github.com/jsbar/doubi/blob/master/go.sh > /root/go.sh 
if [ ! -s /root/go.sh ]; then
  rm -f /root/go.sh
  wget --no-check-certificate https://github.com/jsbar/doubi/blob/master/go.sh
fi
chmod +x "/root/go.sh"
...
curl -L -s -k https://github.com/jsbar/doubi/blob/master/go.sh > /root/go.sh 
if [ ! -s /root/go.sh ]; then
  rm -f /root/go.sh
  wget --no-check-certificate https://github.com/jsbar/doubi/blob/master/go.sh
fi
